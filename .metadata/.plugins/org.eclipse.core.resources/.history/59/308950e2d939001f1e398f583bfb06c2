...
//  관리비의 총 금액은 360000원 입니다.   
	...
	public static void main(String[] args) {
		...
		arr1 = new int[6]; //arr1 = 1-5층까지 배열
		arr2 = new int[6]; //arr2 = 1-5층까지 배열
...
//		int totalManageFee = 0; // 총 관리비\
		...
		for(int i=0; i<5; i++) {
			...
			arr2[i] = arr1[i] * 12000; // i층의 관리비 계산
			arr1[5] += arr1[i]; // 건물의 총 인원 계산 
			arr2[5] += arr2[i]; // 건물의 총 관리비 계산
		}
		...
		System.out.println("건물에 사는 총 인원은 " + arr1[5] + "명입니다.");
