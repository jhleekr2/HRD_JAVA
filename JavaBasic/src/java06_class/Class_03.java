...
//
//- 멤버 필드
//클래스가 객체(인스턴스)로 생성될 때 가지게 될 변수 공간에 대한 선언
//인스턴스마다 사용하는 변수, 상수로 만들어진다
//
//- 멤버 메소드
//객체가 수행할 수 있는 기능, 동작을 정의한다
//
//- 생성자
//객체를 생성(new)할 때 인스턴스를 초기화하기 위해 사용한다
//** 초기화 - 변수(필드)들의 기본값 설정, 객체의 기능에 필요한 설정 등등
//객체를 생성(new)하면 반드시 생성자를 호출하도록 되어있다
//
